{
  ...
  RNROOT::gReactionInfo.SetBeamEnergy(85.5);
  ...
  */
  ...
  gMainAnalyzer.SetRootOutputFile("0623-Early_NeutGatesOff_85p5_AllNeuts.root");
  ...
  //silicon::LoadGates("cuts/prots1.root");
  //ionchamber::LoadGates("cuts/NeBand_hi1.root");
  ...
  ionchamber::LoadGates("cuts/HI_edeGate_21015.root"); // THIS ONE
  ...
  psd::LoadPSDGates("cuts/PSDCuts/n0_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n1_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n2_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n3_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n4_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n5_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n6_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n7_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/n9_neuts_raw_3x.root");
  psd::LoadPSDGates("cuts/PSDCuts/Neut_EvT_Cuts.root");
  psd::LoadPSDGates("cuts/PSDCuts/gammas_raw_0107.root");
