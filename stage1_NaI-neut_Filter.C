{
  ...
  gMainAnalyzer.SetRootOutputFile("filterD_824_NaI_61815.root");  
  
  // This analzyer/filter requires at least mult 1 in both Si dets, and an ICTime>0
  //RNfilters::Stage1SiliconFilterD sifilter;
  
  // This analyzer/filter requires at least one NaI time.
  RNfilters::Stage1NaINeutFilterB naineutfilter;
  ...
  gamma_nai::NaI_Analyzer naianalyzer;
  ...
  gAnalyzer_stack.Add(&naineutfilter);
  gAnalyzer_stack.Add(&naianalyzer);
  ...
  */
  /*820
    Total HRS This Day: 18 hrs 19 mins 
